...
public class ScaleProva : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else if (shrinking)
        {
            ...
            float scale = Mathf.Lerp(2f, 1f, elapsedTime / shrinkDuration);
        ...
        else if (enlarging)
        {
            ...
            float scale = Mathf.Lerp(1f, 2f, elapsedTime / enlargeDuration);
            transform.localScale = new Vector3(scale, scale, scale);
        ...
        else
        {
            ...
            // Allargamento della sfera
            float scale = Mathf.Lerp(1f, 2f, elapsedTime / initialPauseDuration);
            transform.localScale = new Vector3(scale, scale, scale);
